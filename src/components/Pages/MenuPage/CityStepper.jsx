...
const steps = ['در شهر اطلاعات زیادی از مراکز مختلف قرار دارد', 'با پیروی از خط داستانی و جستجو بهینه قاتل را پیدا کنید', 'مشخصات فرد قاتل و دستیارش را برای مرحله آخر بنویسید'];

export default function CityStepper() {
